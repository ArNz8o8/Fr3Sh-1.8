...
proc tghint {} {
	...
	if {$tghintnum >= [expr $tgmaxhintcurrent+1]} {
		...
		if {$tgmaxmissed>0&&$tgmissed>=$tgmaxmissed} {
			append _msg " Hmm... $tgmissed questions gone by unanswered! This room might be ded.. I'll stop for a bit then. To start the game again, type $tgcmdstart"
			tgquietstop
		} else {
