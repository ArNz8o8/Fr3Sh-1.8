...
set bMotionSettings(botnicks) "fresh|fris|prinses|bot|botty"
...
# bracket = "[" and "]"
# angle = "<" and ">"
set bMotionSettings(smiley_type) "random"
...
set bMotionSettings(noAwayFor) { "#fusion" }
...
#         filter those out!
set bMotionSettings(censorwords) "cunt piss decaf"
...
set bMotionSettings(bedtime_minute) "00"

# and the time to wake up
set bMotionSettings(wakeytime_hour) "06"
set bMotionSettings(wakeytime_minute) "00"
